//
// IronMeta RegexpParser Parser; Generated 2013-10-23 19:08:45Z UTC
//
...
namespace Ferric.Utils.Regexp
{
    ...
    using _RegexpParser_Memo = Memo<char, Regexp<InputClass<char>>>;
    using _RegexpParser_Rule = System.Action<Memo<char, Regexp<InputClass<char>>>, int, IEnumerable<IronMeta.Matcher.MatchItem<char, Regexp<InputClass<char>>>>>;
    using _RegexpParser_Base = IronMeta.Matcher.Matcher<char, Regexp<InputClass<char>>>;

    public partial class RegexpParser : IronMeta.Matcher.CharMatcher<Regexp<InputClass<char>>>
    {
        public RegexpParser()
            : base()
        { }
